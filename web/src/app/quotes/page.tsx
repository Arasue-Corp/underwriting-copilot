...
export default function QuotesPage() {
  ...
  const t = {
    es: {
      ...
      selectPayment: "Debes seleccionar al menos una opción de pago (Completo o Mensual) para productos principales",
      enterTotalPremium: "Ingresa la Prima Total para la opción de Pago Completo / Full Term",
      ...
      annualPayment: "Pago Completo / Full Term",
    ...
    en: {
      ...
      selectPayment: "You must select at least one payment option (Full Term or Monthly) for main products",
      enterTotalPremium: "Enter the Total Premium for Full Term option",
      ...
      annualPayment: "Full Payment / Full Term",
